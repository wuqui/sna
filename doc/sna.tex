...
\section{Modeling and measuring the diffusion of lexical innovations}
  ...
  \subsection{Measuring diffusion}
    ...
    \subsubsection{Previous empirical approaches to the diffusion of lexical innovations}
      ...
      Research on lexical innovations has recently seen an upsurge in large-scale empirical investigations on the diffusion of neologisms due to the availability of new data sources and computational methods.
