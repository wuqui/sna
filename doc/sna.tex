...
\section{Results}
  ...
  \subsection{Evaluating frequency and networks}
    ...
    The positive correlation between \textsc{centrality} and \textsc{frequency} confirms earlier observations in Sections~\ref{subsec:sna} which indicated significant overlap for the neologisms with the highest and lowest scores for frequency and degree centrality. For a closer analysis of the relationship between \textsc{frequency} and \textsc{centrality}, Figure~\ref{fig:cent-vs-freq-scatterplot} presents scatterplots that visualise the relationship between both variables for the full sample and for the selected cases.
