...
\section{Results}
  ...
  \subsection{Usage frequency as an indicator of diffusion}
    ...
    \subsubsection{Total usage frequency}
      ...
      \begin{table}
        \caption[Total use frequency counts]{Total usage frequency in the corpus.}
  ...
  \marginpar{total usage frequency will be used to evaluate the social network metrics}
    ...
    \subsubsection{Absolute frequency}
      ...
      \begin{figure}
        ...
        \end{subfigure}
        \caption[Temporal dynamics in absolute usage frequency]{Temporal dynamics in usage frequency for the case study neologisms.}
        \label{fig:freq-abs}
      \end{figure}
    ...
    \subsubsection{Coefficient of variation}
      ...
      \begin{table}
        \caption[Coefficient of variation]{Coefficients of variations.(\textsc{var})\protect\footnotemark}
        \label{tab:coef-var}
        \centering
  ...
  \subsection{Social Network Analysis}
    ...
    \subsubsection{Degrees of diffusion}
      ...
      Table~\ref{tab:cent_last_cases-sample} reports the degree centrality scores for the selected cases, and for six lexemes with the highest and lowest scores in the sample.
      ...
      \begin{table}
        ...
        \begin{subtable}{.3\linewidth}
          ...
          \end{tabular}
        \end{subtable}
        \caption[Degree centrality scores for the selected cases and for the full sample]{Degree centrality scores (\textsc{cent}) for the selected cases and six lexemes each for the highest and lowest scores in the sample.}
        \label{tab:cent_last_cases-sample}
      \end{table}

      The neologisms with the lowest scores for degree centrality are also among the most frequent lexemes in the sample. This indicates that frequency and centrality show similar trends when used to assess degrees of diffusion, which can be seen as cross-validation of both approaches. Notable deviations exist, however, and will be further discusse in Section~\ref{sec:discussion}.

      sample
        lowest: generally most frequent
        highest: topical, political
        --> more detailed analysis in Section~\ref{subsec:nets-vs-freq}
      cases
        correspond
        --> show graphs

      Figure~\ref{fig:cent_last_cases} shows the full network plots for the selected cases for the last subset.
        selection based on comparable number of nodes
      ...
      \begin{figure}[H]
        ...
        \begin{subfigure}{.45\linewidth}
          ...
          \label{subfig:cent_last_cases_upskill}
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \centering
          ...
          \label{subfig:cent_last_cases_hyperlocal}
        \end{subfigure}\\
        \begin{subfigure}{.45\linewidth}
          \centering
          ...
          \label{subfig:cent_last_cases_solopreneur}
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \centering
          % \includegraphics[width=\linewidth]{example-image-a}
          ...
          \label{subfig:cent_last_cases_alt-left}
        \end{subfigure}
        \caption[Social networks of diffusion for selected cases]{Last stages of diffusion for the selected cases.}
        \label{fig:cent_last_cases}
      \end{figure}
    ...
    \subsubsection{Pathways of diffusion}
      ...
      Figure~\ref{fig:cent_diac_cases} presents the pathways of diffusion for all selected cases, measured by degree centralization. The diverging trajectories of centralization over time indicate significant differences in the social dynamics of diffusion between neologisms.

      \begin{figure}
        \centering
        \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{img/cases_cent_diac.pdf}
        \caption[Centralization over time for the selected cases]{Pathways of diffusion for the selected cases. The graph shows values for the \textsc{degree centrality} of the network graphs over time, each \textsc{subset} representing one of four equally-sized time slices for each neologism.}
        \label{fig:cent_diac_cases}
      \end{figure}

      The two neologisms which show the highest degree of diffusion in the final time window are \ol{hyperlocal} and \ol{upskill}.

        In the case of \ol{upskill}, we observe little change over time, its degree of diffusion seems advanced from throughout its entire observed lifespan.
      ...
      zooming in on \ol{hyperlocal}

      Before I discuss these differences, I will present the full network graphs for all stages of diffusion for the prototypical case of \ol{hyperlocal} (\ref{fig:net_diac_hyperlocal}) to illustrate the social dynamics that are captured by the quantitative measure of degree centrality.

      \begin{figure}
        \centering
        \begin{subfigure}{.45\linewidth}
          \caption{\se{Subset 1}\\ (10~September,~2007 -- 8~July~2010; \num{12569}~nodes)}
        ...
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \caption{\se{Subset 2}\\ (9~July,~2010 -- 5~May,~2013; \num{33450}~nodes)}
        ...
        \begin{subfigure}{.45\linewidth}
          \caption{\se{Subset 3}\\ (6~May,~2013 -- 3~March,~2016, \num{29353}~nodes)}
        ...
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \caption{\se{Subset 4}\\ (4~March,~2016 -- 31~December,~2018, \num{26548}~nodes)}
      ...
      Figure~\ref{fig:net_diac_hyperlocal} illustrates that \ol{hyperlocal} shows increasing, successful diffusion over time.
