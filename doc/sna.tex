      ...
      \begin{table}
        ...
        \begin{subtable}[t]{.3\linewidth}
          ...
          \begin{tabular}{
            ...
            \bottomrule
          \end{tabular}
          \subcaption{Neologisms with the lowest coefficient of variation.}
          \label{subtab:coef-var-cases}
        \end{subtable}
        \begin{subtable}[t]{.3\linewidth}
          \centering
          \begin{tabular}{
            ...
            \bottomrule
          \end{tabular}
          \subcaption{Neologisms with the highest coefficient of variation.}
          \label{subtab:coef-var-cases}
        \end{subtable}
      \end{table}
    \footnotetext{Neologisms that have a lifespace shorter than one year and/or were used in less than \num{2000} comments ($n = 5$) were excluded since the coefficient of variation does not provide a robust measure for these outliers.}
