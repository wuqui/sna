...
\section{Results}
  ...
  \marginpar{total usage frequency will be used to evaluate the social network metrics}
    ...
    \subsubsection{Coefficient of variation}
      ...
      \begin{table}
        \caption[Coefficient of variation]{Coefficients of variation (\textsc{var}) for the selected cases, and for six neologism with the highest and lowest scores in the sample.\protect\footnotemark}
        \label{tab:coef-var}
        \centering
  ...
  \subsection{Social Network Analysis}
    ...
    \subsubsection{Degrees of diffusion}
      ...
      \begin{figure}[H]
        \caption[Social networks of diffusion for selected cases]{Social network graphs for the last subset of the selected cases.}
  ...
  \subsection{Networks vs. frequency}
    ...
    \subsubsection{Plotting frequency vs. centrality}
      ...
      \begin{figure}[H]
        ...
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \caption{Zooming in on the selected cases.}
          \centering
