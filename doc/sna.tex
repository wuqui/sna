...
\section{Frequency}
  ...
  This is highly relevant to studying linguistic phenomena on all levels, from investigating preferences in pronunciation between communities, to studying the increasing establishment of grammatical constructions like the \ol{going to}-future over time, to assessing the degree to which new words are conventional in a speech community.
