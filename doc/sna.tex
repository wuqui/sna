...
\section{Discussion}
  ...
  \subsection{Social dynamics of diffusion}
    ...
    In summary, incorporating social network information in addition to frequency data allows for a more accurate and detailed assessment of the pathways and degrees of diffusion.

    For the reasons discussed above, a more differentiated view of the social dynamics of diffusion is of particular relevance to the study of lexical innovations.

    However, social network analysis has great potential for sociolinguistic research in general. One of its biggest advantages is that it is usage-based and captures the communicative behaviour of speakers in interaction and thus enables very fine-grained analyses of the sociolinguistic dynamics of communities which can be visualised and qualitatively inspected on the basis of network graphs. Additionally, network science offers powerful algorithms to quantify and model the social characteristics of communities on a macro level.
