...
\section{Results}
  ...
  The present sample of neologisms covers a broad specturm of usage frequency. Table \ref{tab:freq_total} presents candidates in four groups: six examples around the minimum, the median and the maximum total usage frequency observed in the dataset as well as six words that will serve as case studies in the following sections.
