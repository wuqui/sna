...
\section{Discussion}
  ...
  \subsection{Social dynamics of diffusion}
    ...
    Moreover, neologisms typically arise in specific communities of practice and often show, at least initially, high degrees of social indexicality with regard to these communities. For example, the present dataset includes several examples which are associated with youth language (\ol{fleek}, \ol{lituation}) and political discourse (\ol{birther}, \ol{alt-left}). A term like \ol{alt-left}, which could in principle be used neutrally to designate the political far-left, is highly socially indexical of the far-right community it emerged from.

    Therefore it is less likely to be used by speakers outside it, unless they are willing to be associated with this community.

    can affect diffusion
    needs to be accounted for

    Since its use is strongly associated with this community,


      passive use: discrepancy potentially big
