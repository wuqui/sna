      ...
      Figure XXX presents the cumulative usage frequency for the case study lemmas:
        ...
        \begin{figure}[H]
          ...
          \begin{subfigure}{.3\linewidth}
            \caption{\ol{upskill}}
            \centering
            \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{../out/users/uu_upskill.pdf}
          \end{subfigure}
          \begin{subfigure}{.3\linewidth}
            \caption{\ol{hyperlocal}}
            \centering
            \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{../out/users/uu_hyperlocal.pdf}
          \end{subfigure}
          \begin{subfigure}{.3\linewidth}
          ...
          \begin{subfigure}{.3\linewidth}
            ...
            \centering
            \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{../out/users/uu_alt-right.pdf}
          \end{subfigure}
          \begin{subfigure}{.3\linewidth}
            \caption{\ol{alt-left}}
            \centering
          ...
          \begin{subfigure}{.3\linewidth}
            ...
            \centering
            \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{../out/users/uu_poppygate.pdf}
          \end{subfigure}
        \end{figure}
  ...
  \subsection{Temporal dynamics of usage intensity}
    ...
    case studies
      ...
      \begin{figure}
        ...
        \begin{subfigure}{.3\linewidth}
          \caption{\ol{alt-right}}
          \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{../out/uses/ui_alt-right_time.pdf}
        \end{subfigure}
        \begin{subfigure}{.3\linewidth}
          \caption{\ol{alt-left}}
