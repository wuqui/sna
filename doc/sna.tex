...
% abstract
  ...
  \begin{abstract}
    ...
    Societies continually evolve and speakers coin and use new words to talk about innovative products and practices. While most lexical innovations fail to catch on, others spread successfully and become part of the lexicon.

    This paper investigates the diffusion of English neologisms on Twitter. Previous work on lexical innovation has almost exclusively relied on usage frequency counts for measuring diffusion. Using frequency as a baseline, we employ social network analysis to zoom in on the sociolinguistic dynamics of diffusion.

    Our results show that frequency counts can be used as a coarse measure for assessing overall degrees of diffusion, but it fails to capture important sociolinguistic characteristics.

    Social network information can provide valuable additional information (1)~about the pathways of diffusion, e.g. whether new words show increasing vs. decreasing centralization over time and it (2)~allows for more fine-grained assessments of degrees of diffusion for neologisms, e.g. when the use of new words remains limited to certain parts of the speech community.

    concrete results



    Social network information can thus complement frequency-based accounts for a more differentiated and precise view on the diffusion of lexical innovations.



    \vspace{2\baselineskip}

    \textbf{Keywords}: lexical innovation, neologisms, diffusion, social network analysis, social media, computer-mediated communication, corpus linguistics
