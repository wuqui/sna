  ...
  \subsection{Temporal dynamics of usage intensity}
    ...
    case studies
      ...
      \begin{figure}
        ...
        \end{subfigure}
        \begin{subfigure}{.3\linewidth}
          \caption{\ol{circular economy}}
          \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{"../out/uses/ui_circular economy_time"}
        \end{subfigure}
        \begin{subfigure}{.3\linewidth}
        ...
        \begin{subfigure}{.3\linewidth}
          \caption{\ol{birther}}
          \includegraphics[width=\linewidth, height=.8\textheight, keepaspectratio]{../out/uses/ui_birther_time.pdf}
        \end{subfigure}
      \end{figure}
...
\section{Social networks of diffusion}
  ...
  \subsection{Centralization over time}
    ...
    \subsubsection{Advanced / increasing: \ol{circular economy}}

      \begin{figure}[H]
        \caption{Social network of diffusion for \ol{circular economy} over time.}
        \centering
        \begin{subfigure}{.45\linewidth}
          \caption{First stage}
          \centering
          \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{"../gephi/plots/circular economy_one"}
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \caption{Second stage}
          \centering
          \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{"../gephi/plots/circular economy_two"}
        \end{subfigure}\\
        \begin{subfigure}{.45\linewidth}
          \caption{Third stage}
          \centering
          \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{"../gephi/plots/circular economy_three"}
        \end{subfigure}
        \begin{subfigure}{.45\linewidth}
          \caption{Fourth stage}
          \centering
          \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{"../gephi/plots/circular economy_four"}
        \end{subfigure}
      \end{figure}
