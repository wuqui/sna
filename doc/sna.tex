...
\section{Discussion}
  ...
  \subsection{Social dynamics of diffusion}
    ...
    \todo{The following paragraphs could also be part of the theoretical framework.}
    ...
    \todo{Den Teil ab hier mach ich gerade fertig.}
  ...
  \subsection{Future work}
    ...
    \todo{could potentially be part of the conclusion}
